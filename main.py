...
<main>
  ...
  <div class="dropdown-content">
    <p>Для покупки товара необходимо добавить его в корзину и оформить заказ.</p>
  </div>
</div>
    <div class="dropdown">
      <button>Как доставить?</button>
      <div class="dropdown-content">
        <p>Мы осуществляем доставку товара по всей стране с помощью нашей курьерской службы.</p>
      </div>
    </div>

    <div class="dropdown">
      <button>Какая гарантия?</button>
      <div class="dropdown-content">
        <p>На все наши товары предоставляется гарантия в течение 1 года.</p>
      </div>
    </div>
  </div>
        </main>
